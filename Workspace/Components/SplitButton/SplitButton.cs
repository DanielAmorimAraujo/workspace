...
namespace wyDay.Controls
{
    public class SplitButton : Button
    {
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if ((dropDownRectangle.Contains(e.Location) || dropDown) && !isSplitMenuVisible && e.Button == MouseButtons.Left)
            {
                ShowContextMenuStrip();
            }
            else
        ...
        protected override void OnMouseUp(MouseEventArgs mevent)
        {
            ...
            else if (m_SplitMenuStrip == null && m_SplitMenu == null || !isSplitMenuVisible)
            {
                ...
                if (ClientRectangle.Contains(mevent.Location) && !dropDownRectangle.Contains(mevent.Location) && !dropDown)
                {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            bool drawSplitLine = (State == PushButtonState.Hot || State == PushButtonState.Pressed || !Application.RenderWithVisualStyles) && !dropDown;
        ...
        void SplitMenuStrip_Closing(object sender, ToolStripDropDownClosingEventArgs e)
        {
            ...
            {
                skipNextOpen = (dropDownRectangle.Contains(PointToClient(Cursor.Position)) || (dropDown && ClientRectangle.Contains(PointToClient(Cursor.Position)))) && MouseButtons == MouseButtons.Left;
            }
        }
